...
public class ReminderHistoryRecord
{
    ...
    /// <summary>格式化时间显示：本日只显示 HH:mm:ss，非本日显示 MM-DD HH:mm:ss（对齐原版 formatTime）</summary>
    ...
    /// <summary>类型中文标签（对齐原版 REMINDER_TYPE_LABELS）</summary>
    public string TypeLabel => Type switch
    {
        "price_alert" => "价格提醒",
        "stop_loss" => "止损提醒",
    ...
    /// <summary>级别中文标签（对齐原版 REMINDER_LEVEL_LABELS）</summary>
